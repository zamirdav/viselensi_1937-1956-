...
<HEAD>
   ...
   <TITLE>archiv_stat24_SP_F.asp </TITLE>
</HEAD>
<BODY bgcolor=Tan>
2024  год статистика мпо загрузке фото в выселенцы
<BR>
<%
'Довлетбаев З.С
...
sub STAT_1    ' заполняет массив кол-ва МЕСЯЦЕВ по ДНЯМ--------------------------
   ZAPROS = "Select * From "&Name_Zad & " where AT_V_D >='20240101' AND AT_V_D <='20241231';"
